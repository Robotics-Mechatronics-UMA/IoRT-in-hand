...
class ClientFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            mqttClient.connect( username,
                    ...
                    object : MqttCallback {
                        override fun messageArrived(topic: String?, message: MqttMessage?) {
                            ...
                            /*
                            if (topic == "UR3_publisher/jointValues")
        ...
        view.findViewById<Button>(R.id.button_prefill_cmd).setOnClickListener {
            // Set default values in edit texts
            view.findViewById<EditText>(R.id.edittext_pubtopic).setText(MQTT_TEST_TOPIC)
            view.findViewById<EditText>(R.id.edittext_pubmsg).setText(MQTT_TEST_MSG_deg)
            view.findViewById<EditText>(R.id.edittext_subtopic).setText(MQTT_TEST_TOPIC)
        }

        // Button associated to the end-effector
        view.findViewById<Button>(R.id.button_prefill_ef).setOnClickListener {
            // Set default values in edit texts
            view.findViewById<EditText>(R.id.edittext_pubtopic).setText(MQTT_TEST_TOPIC)
            view.findViewById<EditText>(R.id.edittext_pubmsg).setText(MQTT_TEST_MSG_ef)
            view.findViewById<EditText>(R.id.edittext_subtopic).setText(MQTT_TEST_TOPIC)
        }
        ...
        view.findViewById<Button>(R.id.button_subscribe).setOnClickListener {
            ...
            if (mqttClient.isConnected()) {
                mqttClient.subscribe(topic,
                    ...
                    object : MqttCallback {
                        override fun messageArrived(topic: kotlin.String, message: org.eclipse.paho.client.mqttv3.MqttMessage) {
                            val msg = "Receive message: ${message.toString()} from topic: $topic"
